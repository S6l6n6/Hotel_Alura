...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFormaPago.setModel(new DefaultComboBoxModel<Format>());//new DefaultComboBoxModel<>()<Format>()(new String[] {"Tarjeta de Crédito", "Tarjeta de Débito", "Dinero en efectivo"}));//
