...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		this.setReservaControl(new ReservaControlador());
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel<Format>());
	...
	//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"//	
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
		...
		public ReservaControlador getReservaControl() {
			return reservaControl;
		}

		public void setReservaControl(ReservaControlador reservaControl) {
